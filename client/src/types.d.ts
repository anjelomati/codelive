...
export interface ProjectFilesManagerProps {
...
export interface CodeMirrorEditorProps {
     editorInstance: any;
     setEditorInstance: React.Dispatch<React.SetStateAction<any>>;
     currentFile: ProjectFile | null;
     onEditorChange: (editor: any, data: any, value: string) => void;
}