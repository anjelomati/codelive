...
🆕 5-10-2021: We now have a discussions form, if you want any new feature to be implemented you can [discuss here](https://github.com/Rishabh-malhotraa/codelive/discussions/50)

🆕 28-09-2021: codelive is participating in Hacktoberfest 2021 🥳

## About The Project


### Demonstration
[![Product Demonstation][product-demo]](https://codelive-app.herokuapp.com/)

<br/>

### Collaborative Code Editor

[![Product Name Screen Shot][product-screenshoti]](https://codelive-app.herokuapp.com/)

|                                       Login Page                                       |                                   Navigate Rooms Page                                   |
| :------------------------------------------------------------------------------------: |    :-------------------------------------------------------------------------------------: |
| [![Product Name Screen Shot][product-screenshotii]](https://codelive-app.herokuapp.com/) | [![Product Name Screen Shot][product-screenshotiii]](https://codelive-app.herokuapp.com/) |
